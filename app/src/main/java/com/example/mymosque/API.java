...
public interface API {
    ...
    Call<List<NearestJummah>>
    getJummafromPostalCode(
            @Path("ads_id") int ads_id,
            @Path("postcode") int postcode);
